...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        font.setBold(False)
        font.setWeight(50)
        self.grpProduceSteps.setFont(font)
        ...
        self.txtTitle = QLabel(self.centralwidget)
        self.txtTitle.setObjectName(u"txtTitle")
        self.txtTitle.setGeometry(QRect(250, 20, 381, 31))
        font3 = QFont()
        font3.setFamily(u"Tahoma")
        font3.setPointSize(18)
        font3.setBold(True)
        font3.setWeight(75)
        self.txtTitle.setFont(font3)
        self.txtTitle.setAlignment(Qt.AlignCenter)
        self.txtProcessing = QLabel(self.centralwidget)
        self.txtProcessing.setObjectName(u"txtProcessing")
        self.txtProcessing.setGeometry(QRect(390, 490, 101, 20))
        self.txtProcessing.setFont(font2)
        self.txtProcessing.setAlignment(Qt.AlignCenter)
        ...
        self.menuChemistryLab = QMenu(self.menubar)
        self.menuChemistryLab.setObjectName(u"menuChemistryLab")
        ...
        self.menubar.addAction(self.menuChemistryLab.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.inputSourceChemistry.setText("")
        self.btnTo.setText("")
        self.txtTitle.setText(QCoreApplication.translate("MainWindow", u"\u0110I\u1ec0U CH\u1ebe CH\u1ea4T H\u00d3A H\u1eccC", None))
        self.txtProcessing.setText(QCoreApplication.translate("MainWindow", u"Processing", None))
        ...
        self.menuChemistryLab.setTitle(QCoreApplication.translate("MainWindow", u"ChemistryLab", None))
    # retranslateUi
